...
const Header = () => {
  ...
  return (
    <header className="bg-primary mb-14 flex w-full items-center justify-between sm:justify-center xl:h-[20vh]">
      <div
        className={`flex sm:flex ${abrilFatface.className} text-primary-100 w-fit gap-0.5 p-9 text-2xl font-bold antialiased sm:w-full sm:justify-between sm:text-6xl md:gap-2 md:text-7xl lg:text-8xl xl:text-9xl`}
      >
        <span>
